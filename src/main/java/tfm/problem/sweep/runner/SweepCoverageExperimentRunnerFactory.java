...
public class SweepCoverageExperimentRunnerFactory {
    public static SweepCoverageExperimentRunner produce(File file) throws FileNotFoundException {
        try {
            SweepCoverageExperimentRunner runner = new SweepCoverageExperimentRunner(getNumerOfIndependentRuns(file), getStudyName(file),
