package tfm.selection.comparators;
...
public class AreaCoverageDominanceComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
	private ConstraintViolationComparator<S> constraintViolationComparator;

	/** Constructor */
	public AreaCoverageDominanceComparator() {
		this(new ConstraintViolationComparator<S>());
	}

	/** Constructor */
	public AreaCoverageDominanceComparator(ConstraintViolationComparator<S> constraintComparator) {
